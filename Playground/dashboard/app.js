// Mira Pro Studio | Official Repository Code Executor & WonderCam Camera Stream
let ws;
...
const VISION_GAMES_DATA = {
  "waste_sorting": {
    ...
    "instructions": "Ejecuta el código oficial 'games/waste_sorting/main.py'. La cámara WonderCam sobre el Mira identifica la tarjeta y la coloca en el contenedor correspondiente.",
    "receptacles": [
  ...
  "color_tracking_sorting": {
    ...
    "instructions": "Ejecuta el código oficial 'games/color_tracking_sorting/main.py'. Antes de iniciar, aprende rojo, verde y azul exactamente como ID1, ID2 y ID3 en WonderCam. No uses la vista de cámara del PC: sólo deja listo el módulo y coloca el bloque dentro de la zona de reconocimiento.",
  ...
  "handle_control": {
    ...
    "icon": "🎮",
    "description": "Controla los ejes XYZ, succión y rotación utilizando el mando inalámbrico conectado al puerto USB de la tarjeta Mira.",
    "instructions": "1. Conecta el receptor USB inalámbrico en el puerto USB de la placa Mira.\n2. Enciende el mando pulsando el botón Power/Mode.\n3. Presiona 'Iniciar Juego en ESP32' para cargar 'games/handle_control/main.py'.",
    "receptacles": [
  ...
  "multi_remote_control": {
    ...
    "icon": "📱",
    "description": "Programa maestro para controlar el Mira de forma inalámbrica mediante Mando USB, App Móvil (BLE) y Software PC.",
    "instructions": "Carga 'games/multi_remote_control/main.py' en el ESP32. Permite enlace simultáneo con la App Móvil Hiwonder, Mando USB y Software PC.",
    "receptacles": [
...
function initWebSocket() {
  ...
  ws.onopen = () => {
    logMessage('[SISTEMA] Conexión establecida con el servidor Mira.', 'system');
  };
...
async function populateCameraDevices() {
  ...
  try {
    ...
    videoDevices.forEach((device, idx) => {
      ...
      opt.textContent = label.includes('WonderCam') ? `📷 ${label} (Cámara Mira)` : label;
