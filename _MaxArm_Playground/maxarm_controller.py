...
class MaxArmController:
    """
    Controlador serial para MaxArm vía consola MicroPython REPL / RAW REPL en ESP32 (COM6).
    ...
    def connect(self):
        ...
        try:
            ...
            self.is_connected = True
            print(f"[MaxArmController] [OK] Conectado exitosamente a {self.port} @ {self.baudrate}")
            ...
            self.is_connected = False
            print(f"[MaxArmController] [ERROR] No se pudo abrir {self.port}: {e}")
            return False
    ...
    def exec_micropython(self, cmd: str, force=False):
        ...
        try:
            ...
            print(f"[MaxArmController] Error enviando comando REPL: {e}")
            self.is_connected = False
            return False
    ...
    def exec_raw_repl(self, code_str: str):
        ...
        try:
            ...
            print(f"[MaxArmController] Error en ejecucion Raw REPL: {e}")
            self.is_connected = False
            return False
